...
animal_category = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Data Preprocessing/DataSets-Data Pre Processing/DataSets/animal_category.csv")
...
enc_animal_category = pd.DataFrame(enc.fit_transform(animal_category).toarray()) # 1st they convert into array then dataframe
