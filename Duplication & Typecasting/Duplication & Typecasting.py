...
OnlineRetail = pd.read_csv("C:/Users/Admin/Downloads/data preprocessing/data preprocessing/DataSets/OnlineRetail.csv",encoding='unicode_escape')
...
#Quantity
plt.hist(OnlineRetail.Quantity) #histogram

plt.boxplot(OnlineRetail.Quantity) #boxplot
...
#CustomerID
plt.hist(OnlineRetail.CustomerID) #histogram

plt.boxplot(OnlineRetail.CustomerID) #boxplot
